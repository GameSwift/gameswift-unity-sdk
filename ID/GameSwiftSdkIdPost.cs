...
namespace GameSwiftSDK.Id
{
	...
	public partial class GameSwiftSdkId
	{
			...
			Action<BaseSdkFailResponse> handleFailure)
		{
			...
			{
				Instance._loginAccessToken = loginResponse.accessToken;
			...
			Action<BaseSdkFailResponse> handleFailure)
		{
			...
			{
				FailResponse response = new FailResponse("Cannot use logout endpoint without retrieving access token from login!");
